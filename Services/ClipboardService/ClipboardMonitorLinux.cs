...
/// <summary>
/// Linux implementation of clipboard monitor using polling.
/// Similar to Windows implementation - polls clipboard every 500ms.
/// </summary>
public class ClipboardMonitorLinux : IClipboardMonitor, IDisposable
{
